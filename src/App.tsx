      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <header className="mb-6 sm:mb-8 animate-fade-in">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              <h1 className="font-display text-2xl xs:text-3xl sm:text-5xl font-bold mb-1 sm:mb-2 flex items-center gap-2 sm:gap-3">
                <span className="text-3xl xs:text-4xl sm:text-6xl animate-float">🌊</span>
                <span className="text-ocean-700 dark:text-ocean-300">
                  Hafa Timezones
                </span>
              </h1>
              <p className="text-[var(--color-text-muted)] font-body text-sm sm:text-lg">
                Convert time across timezones instantly • Built in Guam 🌴
              </p>
            </div>
